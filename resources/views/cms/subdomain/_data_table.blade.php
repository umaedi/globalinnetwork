...
<tr>
    ...
    <td>{{ $tb->nama_subdomain }}</td>
    <td>{{ $tb->status }}</td>
    <td style="width: 150px">
        <a href="https://{{ $tb->nama_subdomain . '.' . 'globalinnetwork.com' }}"><span class="badge bg-primary"><i class='bx bx-show'></i></span></a>
        <span class="badge bg-warning" onclick="updateDomain('{{ $tb->id }}', '{{ $tb->nama_subdomain }}')"><i class='bx bxs-edit'></i></span>
        <span class="badge bg-danger" onclick="hapusDomain('{{ $tb->id }}')"><i class='bx bxs-x-circle'></i></span>
    </td>
</tr>
@empty
<tr>
